...
export const appConfig = {
  ...
  // AI Model Configuration — routed through Mesh API (OpenAI-compatible).
  // Model IDs use Mesh's provider-prefixed form and are passed verbatim.
  ai: {
    ...
    // modelApiConfig is unused once provider-manager.ts routes everything
    // through the single Mesh client.
    modelApiConfig: {} as Record<string, never>,
